  ...
  const information = [
    {
      ...
      description: 'Helps you extract information from that pile of research papers and gives you the tools to critically analyse and apply them to your writing.'
    }
  ];
